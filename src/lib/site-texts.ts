...
export const TEXT_SLOTS: TextSlot[] = [
  ...
  },
  {
    ...
    group: 'landing',
    groupLabel: 'Landing principal · Hero',
    label: 'Botón principal (clientes existentes)',
    defaultValue: 'Entrar a mi cuenta',
  ...
  },
  {
    ...
    group: 'landing',
    groupLabel: 'Landing principal · Hero',
    label: 'Botón secundario (farmacias nuevas)',
    defaultValue: 'Quiero ser cliente',
    type: 'short', maxLength: 40,
  },
  {
  ...
  // === Tarjeta visual del hero (cuando hay foto custom subida) ===
  {
    key: 'landing.hero_card_titulo',
    group: 'landing',
    groupLabel: 'Landing principal · Tarjeta visual hero',
    label: 'Tarjeta hero — Título (sobre la foto)',
    description: 'Solo se muestra si hay foto subida en "Pulsera publicitaria"',
    defaultValue: 'Pulseras Lomhifar',
    type: 'short', maxLength: 60,
  },
  {
    key: 'landing.hero_card_badge',
    group: 'landing',
    groupLabel: 'Landing principal · Tarjeta visual hero',
    label: 'Tarjeta hero — Badge (etiqueta esquina)',
    defaultValue: 'negra · roja',
    type: 'short', maxLength: 30,
  },
  {
    key: 'landing.hero_kv1_label',
    group: 'landing',
    groupLabel: 'Landing principal · Tarjeta visual hero',
    label: 'KPI 1 — Etiqueta',
    defaultValue: 'Material',
    type: 'short', maxLength: 30,
  },
  {
    key: 'landing.hero_kv1_valor',
    group: 'landing',
    groupLabel: 'Landing principal · Tarjeta visual hero',
    label: 'KPI 1 — Valor',
  ...
  {
    key: 'landing.hero_kv2_label',
    group: 'landing',
    groupLabel: 'Landing principal · Tarjeta visual hero',
    label: 'KPI 2 — Etiqueta',
    defaultValue: 'Grabado',
    type: 'short', maxLength: 30,
  },
  {
    key: 'landing.hero_kv2_valor',
    group: 'landing',
    groupLabel: 'Landing principal · Tarjeta visual hero',
    label: 'KPI 2 — Valor',
    defaultValue: 'Láser',
  ...
  {
    key: 'landing.hero_kv3_label',
    group: 'landing',
    groupLabel: 'Landing principal · Tarjeta visual hero',
    label: 'KPI 3 — Etiqueta',
    defaultValue: 'Colores',
    type: 'short', maxLength: 30,
  },
  {
    key: 'landing.hero_kv3_valor',
    group: 'landing',
    groupLabel: 'Landing principal · Tarjeta visual hero',
    label: 'KPI 3 — Valor',
    defaultValue: 'Negra/Roja',
