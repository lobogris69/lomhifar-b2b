 ...
 *
 * VIVE EN SU PROPIO ARCHIVO porque importa getSiteImageMeta() que a su vez
 * usa node:fs y node:path. Si lo pusiéramos junto a PosterCalloutInline,
 * webpack lo arrastraría al bundle del cliente al ser importado por
 * ShopHeader.tsx ('use client').
 */
